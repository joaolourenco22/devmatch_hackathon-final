  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-violet-50 to-indigo-50/30 text-gray-900">
      ...
      <main className="flex-1 flex flex-col min-h-screen">
        {user && (
          <div className="sticky top-0 z-30 flex items-center justify-between px-4 py-2 border-b bg-violet-600 text-white border-violet-700/30">
            <div className="text-sm text-white"><span className="font-bold">Bem-vindo!</span></div>
